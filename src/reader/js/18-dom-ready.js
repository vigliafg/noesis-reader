    window.addEventListener('DOMContentLoaded', () => {
      ...
      window.__test = {
        ...
        get userBookmarks() { return userBookmarks; },
        renderUbmList: renderUbmList,
        createUserBookmark: createUserBookmark,
        openUbmDrawer: openUbmDrawer,
        closeUbmDrawer: closeUbmDrawer,
        saveUserBookmarksToDB: saveUserBookmarksToDB,
        loadUserBookmarksFromDB: loadUserBookmarksFromDB,
